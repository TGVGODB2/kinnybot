...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        chw.on('collect', async role => {
            ...
            let chl = message.channel.createMessageCollector({ filter, time: 15000 })
            ...
            chl.on('collect', async saida => {
                ...
                let autorole = message.channel.createMessageCollector({ filter, time: 15000 })
                ...
                autorole.on('collect', async ro => {
                    ...
                    let msg1 = message.channel.createMessageCollector({ filter, time: 15000 })
                    ...
                    msg1.on('collect', async msg => {
                        ...
                        let msg2 = message.channel.createMessageCollector({ filter, time: 15000 })
